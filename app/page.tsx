  ...
  return (
    <div className="flex flex-col items-center justify-center text-center px-4 sm:px-6 py-12 md:py-24 max-w-3xl mx-auto">
      <div className="flex flex-wrap items-center justify-center gap-2 mb-6">
        ...
        <Badge
          variant="outline"
          className="border-blue-500/40 text-blue-500 px-3 py-1 text-xs font-medium"
        >
          Blue Belt
        </Badge>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <p className="text-xs text-muted-foreground">
                  Your Stellar wallet is connected. All transactions are signed by you.
                </p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="rounded-xl border border-border bg-card p-6">
                <h3 className="text-sm font-semibold mb-2">Onboarding Progress</h3>
                <Badge variant="secondary">Level 5 Blue Belt</Badge>
                <p className="text-xs text-muted-foreground mt-2">
                  Complete feedback to help improve Divify.
                </p>
              </div>
            </div>
          </div>
